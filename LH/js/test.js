...
function checkAndInitSwiper() {
    ...
    if ($(window).width() < 768) {
        ...
        console.log("thump 123123");
        console.log("slide 1231321");
        if (thumb != undefined) thumb.destroy(true, true);
        if (slide != undefined) slide.destroy(true, true);
...
var slide = new Swiper($for, jQuery.extend({
    ...
    on: {
        slideChange: function () {
            ...
            console.log('Slide changed to index: ', slide.realIndex);
        },
